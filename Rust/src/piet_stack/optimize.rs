...
impl super::PietStackExecutor {
    pub fn optimize(&mut self) {
        for (k, v) in self.blocks.clone() {
            ...
            //                 Not => {
            //                     new_block[i] =
            //                         Instr(Push(if a == 0.into() { 1.into() } else { 0.into() }));
            ...
            //     if i + 2 < new_block.len() {
            //         if let [Instr(Push(ZERO)), Instr(_op @ (Add | Sub))] = new_block[i.to_usize().unwrap()..i.to_usize().unwrap() + 2] {
            //             new_block.remove(i);
            //             new_block.remove(i);
            ...
            //     if i + 2 < new_block.len() {
            //         if let [Instr(Push(ONE)), Instr(_op @ (Mul | Div))] =
            ...
            //     //     if let [Instr(Push(3)), Instr(Push(ONE)), Instr(Roll), Instr(Push(2)), Instr(Push(1 | -1)), Instr(Roll)] =
            //     //         new_block[i..i + 6]
            //     //     {
